    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative">
                    <input type="text" class="bg-gray-800 rounded-full w-64 px-4 pl-8 py-1 hover:bg-blue-900 focus:outline-none focus:shadow-outline" placeholder="Search">
                    <div class="absolute top-8">
                        <svg class="fill-current w-5 text-gray-500 ml-2 -mt-6 " viewBox="0 0 28 24" ><path class="heroicon-ui" d="M16.32 14.9l5.39 5.4a1 1 0 01-1.42 1.4l-5.38-5.38a8 8 0 111.41-1.41zM10 16a6 6 0 100-12 6 6 0 000 12z"/></svg>
                    </div>
                    <div class="md:ml-4 -mt-8 pl-64 ">
                        <a href="#">
                            <img src="/img/men.jpg" alt="avatar" class="rounded-full w-8 h-8">
                        </a>
